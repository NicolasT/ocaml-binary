...
(* OASIS_START *)
(* DO NOT EDIT (digest: f44ef50ecd04b4cc9fc81fed043dfee3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/NicolasT/ocaml-binary";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build Lwt bindings";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build demo";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build benchmarks";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Binary_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "binary";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "demo.ml"; });
               Executable
                 ({
                     cs_name = "binary_bench_string_sub";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "benchmark", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "bench";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "bench_string_sub.ml";
                      });
               Executable
                 ({
                     cs_name = "binary_bench_applicative_monad";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "bench_applicative_monad.ml";
                      });
               SrcRepo
                 ({
                     cs_name = "head";
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/NicolasT/ocaml-binary.git";
                      src_repo_browser =
                        Some
                          "http://github.com/NicolasT/ocaml-binary/tree/master";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "http://github.com/NicolasT/ocaml-binary/tree/0.0.1";
                      src_repo_module = None;
                      src_repo_branch = None;
                      src_repo_tag = Some "0.0.1";
                      src_repo_subdir = None;
                      })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "2\156^\129\163\030\213O\r\186a\138\191\220\024\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
